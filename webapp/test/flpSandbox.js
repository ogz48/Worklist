		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Worklist From Template",
									"targetURL": "#WorklistFromTemplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"WorklistFromTemplate-display": {
								"semanticObject": "WorklistFromTemplate",
								"action": "display",
								"description": "Worklist From Template Denemesi",
								"title": "Worklist From Template",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.egitim.Worklist",
									"url": sap.ui.require.toUrl("com/egitim/Worklist")
								}
							}
						}
					}
